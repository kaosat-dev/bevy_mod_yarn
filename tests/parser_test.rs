            ...
            branch: {
                Branch {
                    statements: vec![
                        ...
                        Statements::Dialogue(Dialogue {
                            who: "Lamik".into(),
                            what: "some other stuff".into(),
                            ..Default::default()
                        }),
                        Statements::Command(YarnCommand {
                            name: "blowup".into(),
                            params: "universe,now".to_string(),
                            command_type: Commands::Generic,
                            ..Default::default()
                        }),
                        Statements::Exit,
                    ],
                                ...
                                Branch {
                                    statements: vec![
                                        ...
                                        Statements::Choice(Choice {
                                            branches: vec![
                                                Branch {
                                                    statements: vec![Statements::Dialogue(
                                                        Dialogue {
                                                            who: "nobody".into(),
                                                            what: "A1".into(),
                                                            ..Default::default()
