use bevy_mod_yarn::prelude::{
    parse_yarn_nodes, Branch, Choice, Commands, Dialogue, DialogueRunner, Statements, YarnAsset,
    YarnCommand,
};
...
fn test_evaluate_minimal() {
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "Dona".into(),
        what: "what is wrong ?".into(),
        ..Default::default()
    });
...
fn test_evaluate_branching_basic() {
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "nobody".into(),
        what: "it was a beautiful day , said nobody".into(),
        ..Default::default()
    });
    assert_eq!(current_statement, expected);
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "Dona".into(),
        what: "good morning , how are you ?".into(),
        ..Default::default()
    });
    assert_eq!(current_statement, expected);
    ...
    dialogue_runner.next_entry();
    let current_statement = dialogue_runner.current_statement();
    let expected = Statements::Choice(Choice {
        branches: vec![
            Branch {
                statements: vec![
                    Statements::Dialogue(Dialogue {
                        who: "Lamik".into(),
                        what: "are you asking me ?".into(),
                        ..Default::default()
                    }),
                    Statements::Dialogue(Dialogue {
                        who: "Dona".into(),
...
fn test_evaluate_branching_nested_multinode() {
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "Dona".into(),
        what: "so... what have you been up to ?".into(),
        ..Default::default()
    });
    assert_eq!(current_statement, expected);
    ...
    let expected = Statements::Choice(Choice {
        branches: vec![
            Branch {
                statements: vec![Statements::Dialogue(Dialogue {
                    who: "Lamik".into(),
                    what: "hmmm...".into(),
                    ..Default::default()
                })],
            ...
            Branch {
                statements: vec![
                    Statements::Dialogue(Dialogue {
                        who: "Lamik".into(),
                        what: "i have started working on the most AMAZING project ever !".into(),
                        ..Default::default()
                    }),
                    Statements::Dialogue(Dialogue {
                        who: "Dona".into(),
                        what: "ohh cool , tell me more !!".into(),
                        ..Default::default()
                    }),
                        ...
                        branches: vec![
                            Branch {
                                statements: vec![
                                    Statements::Dialogue(Dialogue {
                                        who: "Lamik".into(),
                                        what: "short version then".into(),
                                        ..Default::default()
                                    }),
                                    Statements::Dialogue(Dialogue {
                                        who: "Lamik".into(),
                                        what: "a mechanical bunny of doom !".into(),
                                        ..Default::default()
                                    }),
                                ],
                            },
                            Branch {
                                statements: vec![
                                    Statements::Dialogue(Dialogue {
                                        who: "Lamik".into(),
                                        what: "the long version ? here goes".into(),
                                        ..Default::default()
                                    }),
                                    Statements::Command(YarnCommand {
                                        name: "jump".into(),
                                        params: "project_long".to_string(),
                                        command_type: Commands::Jump,
                                        ..Default::default()
                                    }),
                                ],
                            },
            ...
            Branch {
                statements: vec![
                    Statements::Dialogue(Dialogue {
                        who: "Lamik".into(),
                        what: "too early to tell".into(),
                        ..Default::default()
                    }),
                    Statements::Dialogue(Dialogue {
                        who: "Dona".into(),
                        what: "oh ok, well, anyway, gotta go !".into(),
                        ..Default::default()
                    }),
                ],
            },
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "Lamik".into(),
        what: "so as I was saying, a mechanical bunny of doom ! ".into(),
        ..Default::default()
    });
    assert_eq!(current_statement, expected);
    ...
    let expected = Statements::Dialogue(Dialogue {
        who: "Lamik".into(),
        what: "... with floppy ears of course".into(),
        ..Default::default()
    });
    assert_eq!(current_statement, expected);
